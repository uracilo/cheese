...
ActiveRecord::Schema.define(version: 20161202031600) do
  ...
  create_table "products_descriptions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_products_descriptions_on_user_id", using: :btree
  end
  ...
  add_foreign_key "products_descriptions", "users"
